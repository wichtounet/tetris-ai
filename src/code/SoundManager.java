...
import static code.ProjectConstants.getResStream;
...
/*
 * This class loads, plays, and manages sound effects and music for Tetris4j.
 * The sound URL's are hardcoded into this class and is loaded statically at
 * runtime.
 */
public class SoundManager {
    ...
    /*
     * Since this class locks certain system resources, it's best to only have
     * one instance of this class. If an instance of SoundManager already
     * exists, this replaces that with a new instance.
     */
    ...
    /*
     * Plays a sound. Sounds should be short because once this is called again,
     * the previous sound teminates and the new sound starts.
     */
    ...
    /*
     * Plays a music track. Currently the only track is the default MIDI track
     * (theme song).
     */
    ...
    private static AudioClip loadsound(String name)
        ...
        if (new File(getResURL(name).getFile()).exists()) {
            ...
            throw new IOException("NOT FOUND: " + getResURL(name));
        }
    }
}
